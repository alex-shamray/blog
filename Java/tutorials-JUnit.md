...
* [4. Testing frameworks for Java](#4-testing-frameworks-for-java)
* [5. Using JUnit](#5-using-junit)
    * [5.1. The JUnit framework](#51-the-junit-framework)
    * [5.2. How to define a test in JUnit?](#52-how-to-define-a-test-in-junit)
    * [5.3. Example JUnit test](#53-example-junit-test)
    * [5.4. JUnit naming conventions](#54-junit-naming-conventions)
    * [5.5. JUnit naming conventions for Maven](#55-junit-naming-conventions-for-maven)
    * [5.6. JUnit test suites](#56-junit-test-suites)
    * [5.7. Run your test from the command line](#57-run-your-test-from-the-command-line)
* [6. Basic JUnit code constructs](#6-basic-junit-code-constructs)
    * [6.1. Available JUnit annotations](#61-available-junit-annotations)
    * [6.2. Assert statements](#62-assert-statements)
    * [6.3. Test execution order](#63-test-execution-order)
* [7. Installation of JUnit](#7-installation-of-junit)
    * [7.1. Using JUnit with Gradle](#71-using-junit-with-gradle)
    * [7.2. Using JUnit integrated into Eclipse](#72-using-junit-integrated-into-eclipse)
    * [7.3. Downloading the JUnit library](#73-downloading-the-junit-library)
* [8. Eclipse support for JUnit](#8-eclipse-support-for-junit)
    * [8.1. Creating JUnit tests](#81-creating-junit-tests)
    * [8.2. Running JUnit tests](#82-running-junit-tests)
    * [8.3. JUnit static imports](#83-junit-static-imports)
    * [8.4. Wizard for creating test suites](#84-wizard-for-creating-test-suites)
    * [8.5. Testing exception](#85-testing-exception)
    * [8.6. JUnit Plug-in Test](#86-junit-plug-in-test)
* [9. Setting Eclipse up for using JUnits static imports](#9-setting-eclipse-up-for-using-junits-static-imports)
* [10. Exercise: Using JUnit](#10-exercise-using-junit)
    * [10.1. Project preparation](#101-project-preparation)
    * [10.2. Create a Java class](#102-create-a-java-class)
    * [10.3. Create a JUnit test](#103-create-a-junit-test)
    * [10.4. Run your test in Eclipse](#104-run-your-test-in-eclipse)
* [11. Advanced JUnit options](#11-advanced-junit-options)
    * [11.1. Parameterized test](#111-parameterized-test)
    * [11.2. JUnit Rules](#112-junit-rules)
    * [11.3. Writing custom JUnit Rules](#113-writing-custom-junit-rules)
    * [11.4. Categories](#114-categories)
* [12. Mocking](#12-mocking)
* [13. Links and Literature](#13-links-and-literature)
    * [13.1. Source Code](#131-source-code)
    * [13.2. JUnit Resources](#132-junit-resources)
...
-----------|------------
<code>@Test<br> public void method()</code> | The `@Test` annotation identifies a method as a test method.
